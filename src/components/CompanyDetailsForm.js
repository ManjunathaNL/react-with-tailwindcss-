  ...
  return (
    <div>
      <Card color="transparent" shadow={false}>
        <form
          className="mt-8  mb-2 w-full  max-w-screen-xl sm:w-100"
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 ml-6 items-start justify-evenly justify-items-stretch">
            <div className="grid grid-cols-1 gap-6  ">
              ...
              {showAlternativeNumber ? (
                <Input
                  ...
                  className=" block w-full rounded-md h-10 pl-3 bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
                  labelProps={{
                    className: "before:content-none after:content-none",
                  }}
                  onChange={handleChange}
              ...
              <Textarea
                ...
                className=" block w-full  p-3 text-start rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
                labelProps={{
                  className: "before:content-none after:content-none",
                }}
                onChange={handleChange}
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <p
                ...
                className=" text-blue-600 font-medium text-sm  -mt-6 rounded focus:outline-none"
              >
          ...
          <div className="flex justify-center w-100  space-x-12 ">
            <Button
              ...
              className="border-2 w-32 h-11  rounded-md mt-6 border-blue-400 focus:!border-blue-900 bg-white-600 text-blue-400"
            >
              Cancel
            </Button>
            <Button
              ...
              type="submit"
              name="submit"
              className=" border-2 w-32 h-11  rounded-md mt-6 border-blue-400 focus:!border-blue-900 bg-[#60a5fa] text-white"
            >
              Save
            </Button>
